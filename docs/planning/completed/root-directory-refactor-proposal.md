...
### 4. **Documentation** (`agents/docs/`)

**Important**: Understand the distinction:

- **`agents/docs/agents/`** = Documentation FOR agents (codebase guide, conventions, how things work)
- **`agents/`** = Agent SPECIFICATIONS (how agents should behave/work)
- **Other `agents/docs/`** = General project documentation

The Agent Writing Agent uses `agents/docs/` as SOURCES to fill in agent specs, but agent specs themselves live in `agents/`.

Move markdown documentation files:

- `booking-relationships-2025-12-01T12-57-11-471Z.md` → `agents/docs/migrations/`
- `firebase-booking-links-2025-12-01T12-51-51-732Z.md` → `agents/docs/migrations/`
- `occupancy_calculation_documentation.md` → `agents/docs/features/`
- `OFFLINE_BOOKING_TEST_README.md` → `agents/docs/testing/`
